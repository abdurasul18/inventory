            ...
            <Table class="border-spacing-y-[10px] border-separate sm:mt-2">
              ...
              <Table.Tbody>
                <Table.Tr v-for="(faker, fakerKey) in _.take(fakerData, 4)" :key="fakerKey" class="intro-x">
                  <Table.Td
                    class="first:rounded-l-lg last:rounded-r-lg border-y border-slate-200 first:border-l last:border-r w-40 bg-white border-b-0 dark:bg-darkmode-600 shadow-[20px_3px_20px_#0000000b]">
                    <div class="flex">
                  ...
                  <Table.Td
                    class="first:rounded-l-lg last:rounded-r-lg border-y border-slate-200 first:border-l last:border-r bg-white border-b-0 dark:bg-darkmode-600 shadow-[20px_3px_20px_#0000000b]">
                  ...
                  <Table.Td
                    class="first:rounded-l-lg last:rounded-r-lg border-y border-slate-200 first:border-l last:border-r text-center bg-white border-b-0 dark:bg-darkmode-600 shadow-[20px_3px_20px_#0000000b]">
                    {{ faker.stocks[0] }}
                  </Table.Td>
                  <Table.Td
                    class="first:rounded-l-lg last:rounded-r-lg border-y border-slate-200 first:border-l last:border-r w-40 bg-white border-b-0 dark:bg-darkmode-600 shadow-[20px_3px_20px_#0000000b]">

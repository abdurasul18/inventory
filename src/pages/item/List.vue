    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        ...
        <div class="col-span-12 overflow-auto intro-y 2xl:overflow-visible">
            <Table class="border-spacing-y-[10px] border-separate -mt-2">
                ...
                <Table.Tbody>
                    <Table.Tr v-for="(faker, fakerKey) in _.take(fakerData, 9)" :key="fakerKey" class="intro-x">
                        <Table.Td
                        ...
                        <Table.Td
                            ...
                            <div class="flex items-center">
                                <div class="w-9 h-9 image-fit zoom-in">
                                    <Tippy as="img" alt="Midone - HTML Admin Template"
    ...
    <Dialog :open="deleteConfirmationModal" @close="() => {
        ...
        <Dialog.Panel>
            ...
            <div class="px-5 pb-8 text-center">
                ...
                <Button variant="danger" type="button" class="w-24" ref="deleteButtonRef">
                    Delete
                </Button>
            </div>
        </Dialog.Panel>
